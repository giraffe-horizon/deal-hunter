...
- Interactive profile creator (`--init`) — walks through creating a new YAML profile with source selection, budget, scoring keywords, and notification setup
- Dockerfile and docker-compose.yml for running Deal Hunter on a cron schedule in a container
- Docker entrypoint with configurable `CRON_SCHEDULE` environment variable (default: every 30 minutes)
- .dockerignore for clean Docker builds

### Changed

- README: rewritten "Why Deal Hunter?" section emphasizing universal web scraping capability
- README: repositioned features to lead with "works with ANY website", Polish sites as included batteries
- README: added "Running with Docker" section with docker-compose instructions
- README: added `--init` to Quick Start and Usage sections
- README: added demo GIF placeholder for future screenshot/recording
